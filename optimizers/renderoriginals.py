...
def renderOriginals(directory, config, extension="exr", fileFormat="openexr", samples=1024):
    ...
    for i, lt in enumerate(lts):
        ...
        if not "-lonly" in sys.argv:
            print("mitsuba " + scenefile + " -o " + directory + "/originals/" + format(i).zfill(4) + "." + extension + " -DlightX=" + lt[0] + " -DlightY=" + lt[1] + " -DlightZ=" + lt[2] + " -Ddepth=-1 -DsampleCount=" + format(samples) + " -Dmesh=" + meshfile + " -Dext=" + fileFormat + " " + serverstring)
            os.system("mitsuba " + scenefile + " -o " + directory + "/originals/" + format(i).zfill(4) + "." + extension + " -DlightX=" + lt[0] + " -DlightY=" + lt[1] + " -DlightZ=" + lt[2] + " -Ddepth=-1 -DsampleCount=" + format(samples) + " -Dmesh=" + meshfile + " -Dext=" + fileFormat + " " + serverstring)
