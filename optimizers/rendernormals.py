...
def renderMesh(meshname, scenename, targethdsfile, targetnpyfile, W=256, H=256, autoskip=False):
    ...
    if (not autoskip) or (not os.path.exists(targetnpyfile) and os.path.exists(targethdsfile)):
