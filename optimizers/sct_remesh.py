...
tempfile = "/tmp/tempmesh.ply"
rescaleMesh(initialmesh, W, H, tempfile, edge_protect=1, mask=mask)

"""
vertices, normals, indices = remesher.plyutils.readPLY(tempfile)
...
targetmesh = directory + "/originals/xout.ply"
...
masked_remesh(tempfile, targetmesh, W, H, mask=np.squeeze(mask), rescale=False)