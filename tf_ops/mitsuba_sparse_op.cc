        ...
        class MitsubaOp : public OpKernel {
            public:
                ...
                void Connect(int port) {
                    std::cerr << "[Sparse Op] Opening port: " << port << std::endl;
                ...
                void Compute(OpKernelContext* context) override {
                    ...
                    const Tensor& map_tensor = context->input(3);
                    ...
                    // Write the normal and refernce map out.
                    ...
                    if(dims != 1) {
                        std::cerr << "[Sparse Op] Dimensions not equal to 1 Dims: " << dims << std::endl;
                        exit(1);
                    }
                     
                    //TODO: Free memory.
                    float *data = (float*) malloc(sizeof(float) * r * c * dims);
                    ...
                    while(true){
                        ...
                        if(k == -1) {
                            std::cerr << "[Sparse Op] ERROR while reading: " << strerror(errno) << std::endl ;
                            exit(1);
                        }
