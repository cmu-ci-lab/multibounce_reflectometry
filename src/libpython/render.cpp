...
void export_render() {
    ...
    size_t (Sampler::*get_sample_count1)(void) const = &Sampler::getSampleCount;
    size_t (Sampler::*get_sample_count2)(const Point2i&) const = &Sampler::getSampleCount;
    BP_CLASS(Sampler, ConfigurableObject, bp::no_init)
        ...
        .def("getSampleCount", get_sample_count1)
        .def("getSampleCount", get_sample_count2)
    ...
    BP_CLASS(ImageBlock, WorkResult, (bp::init<Bitmap::EPixelFormat, const Vector2i &, bp::optional<const ReconstructionFilter *, const Sampler*, int, bool> >()))
