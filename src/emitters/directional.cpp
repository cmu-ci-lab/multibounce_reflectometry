...
public:
    ...
    Spectrum samplePosition(PositionSamplingRecord &pRec, const Point2 &sample, const Point2 *extra) const {
        ...
        pRec.measure = EArea;
        //std::cout << std::endl << "PDF: " << pRec.pdf << std::endl;
        //std::cout << std::endl << "Power: " << m_power.toString() << std::endl;
        //std::cout << std::endl << "radius: " << m_bsphere.radius << std::endl;
        //std::cout << std::endl << "irradiance: " << m_normalIrradiance.toString() << std::endl;
        return m_power;
    }
