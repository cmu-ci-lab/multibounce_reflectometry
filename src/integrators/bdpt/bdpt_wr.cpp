...
BDPTWorkResult::BDPTWorkResult(const BDPTConfiguration &conf,
        const ReconstructionFilter *rfilter, const Sampler *sampler, Vector2i blockSize) {
    ...
    m_block = new ImageBlock(Bitmap::ESpectrumAlphaWeight, blockSize, rfilter, sampler);
