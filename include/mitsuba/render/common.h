...
public:
    ...
    /**
     * \brief Optional: 2D discrete sample position
     *
     * Intended for setting the discrete sampling point on the aperture 
     * of a sensor that is associated with the current sample.
     * This is required to compute importance weights in case the 
     * discrete sampling points have non-uniform pdfs.
     * 
     * Set to -1 to ignore.
     */
    Point2i uv_disc;
