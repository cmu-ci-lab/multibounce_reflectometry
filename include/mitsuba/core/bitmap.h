...
protected:
    ...
    /// Write a file using the HDS file format
    void writeHDRStream(Stream *stream) const;
    
    /// Read a file using the HDS file format
    void readHDRStream(Stream *stream);
